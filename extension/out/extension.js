        ...
        provideDocumentSymbols(document, token) {
            ...
            for (let i = 0; i < lines.length; i++) {
                ...
                if (varMatch) {
                    ...
                    const symbol = new vscode.DocumentSymbol(varName, `Variable (${varMatch[1]})`, vscode.SymbolKind.Variable, range, range);
                    symbols.push(symbol);
                }
            }
            return symbols;
